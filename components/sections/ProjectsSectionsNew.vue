<template>
  <div class="min-h-screen py-4 md:py-10 b-primary flex max-w-full">
    <div class="w-full mx-auto flex flex-col md:flex-col gap-10 px-4 md:px-0">
      <TitleSection>{{ t({ id: 'Proyek', en: 'Projects' }) }}</TitleSection>
      <!-- Gunakan grid responsif: 1 kolom di mobile, 5 kolom di medium+ -->
      <div class="grid grid-cols-1 md:grid-cols-5 grid-rows-auto gap-6">
        <!-- Feliya Attendance -->
        ...
        <!-- Klik Sewa -->
        <div class="col-span-1 md:col-span-3 md:row-start-2 flex flex-col gap-6">
          <div>
            <img
          ...
          <div class="flex flex-col gap-3">
            <div class="flex flex-col gap-6">
              ...
              <TechStackDropdown>
                <!-- (TechStack sama seperti sebelumnya, tidak diubah) -->
                <TechStack text="Android App">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-green-500">
                      <title>Android</title>
        ...
        <div class="col-span-1 md:col-span-2 md:col-start-4 md:row-start-2 flex flex-col gap-6">
          <div>
            <img
            ...
            <div class="flex flex-col gap-6">
              ...
              <TechStackDropdown>
                ...
                <TechStack text="JavaScript Language">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#F7DF1E]">
                ...
                <TechStack text="Vue.js Framework">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#4FC08D]">
                      <title>Vue.js</title>
                ...
                <TechStack text="Tailwind CSS">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#06B6D4]">
                ...
                <TechStack text="HTML 5">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#E34F26]">
                      <title>HTML5</title>
                ...
                <TechStack text="CSS 3">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#1572B6]">
                      <title>CSS3</title>
                ...
                <TechStack text="Node.js">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#5FA04E]">
                      <title>Node.js</title>
                ...
                <TechStack text="Leaflet">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#199900]">
                      <title>Leaflet</title>
                ...
                <TechStack text="Daisy UI">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#1AD1A5]">
                      <title>DaisyUI</title>
        ...
        <!-- Zarqa Backend API -->
        <div class="col-span-1 md:col-span-2 md:row-start-3 flex flex-col gap-6">
          <div>
            <img
            ...
            <div class="flex flex-col gap-6">
              ...
              <TechStackDropdown>
                ...
                <TechStack text="Backend API">
                  <template #icon>
                    <img src="~/assets/images/backend_system.png" class="w-6 h-6" />
                  </template>
                </TechStack>
                <TechStack text="JavaScript Language">
                  <template #icon>
                ...
                <TechStack text="Hono.js">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#E36002]">
                      <title>Hono</title>
                ...
                <TechStack text="Bun">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#fbf0df]">
                      <title>Bun</title>
                ...
                <TechStack text="Prisma">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#ffffff]">
                      <title>Prisma</title>
                ...
                <TechStack text="Mongo DB NoSQL">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#47A248]">
                      <title>MongoDB</title>
                ...
                <TechStack text="Zod">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#3E67B1]">
                      <title>Zod</title>
                ...
                <TechStack text="Pino">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#687634]">
                      <title>pino</title>
                ...
                <TechStack text="Nodemon">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#76D04B]">
                      <title>Nodemon</title>
              ...
              <p class="text-gray-300">
                {{ t({
                id: 'Ini adalah project Backend API untuk aplikasi mobile Zarqa. Backend ini dibangun mengunakan JavaScript dan berjalan di atas runtime super cepat Bun, dengan menggunakan framework minimalis Hono untuk menangani routing HTTP. Sistem ini dirancang untuk memberikan performa tinggi sekaligus menjaga keamanan dan skalabilitas.',
                en: 'This is a Backend API project for the Zarqa mobile application. This backend is built using JavaScript and runs on top of the super-fast Bun runtime, using the minimalist Hono framework to handle HTTP routing. This system is designed to deliver high performance while maintaining security and scalability.'
              }) }}
              </p>
            </div>
          </div>
        ...
        <div class="col-span-1 md:col-span-3 md:col-start-3 md:row-start-3 flex flex-col gap-6">
          <div>
            <img
                src="~/assets/images/feliya_laju_teknik.png"
                alt="Feliya Laju Teknik"
                class="rounded-2xl w-full"
            />
          </div>
          <div class="flex flex-col gap-3">
            <div class="flex flex-col gap-6">
              ...
              <TechStackDropdown>
                ...
                <TechStack text="Nuxt.js">
                  <template #icon>
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-[#00DC82]">
                      <title>Nuxt</title>
              ...
              <p class="text-gray-300">
                {{ t({
                id: 'Website ini merupakan proyek company profile digital untuk PT Feliya Laju Teknik, sebuah perusahaan yang bergerak di bidang jasa instalasi dan perawatan sistem pendingin serta HVAC. Proyek ini dibangun sebagai bagian dari program magang dan bertujuan untuk membantu perusahaan dalam menghadirkan wajah profesional secara online.',
                en: 'This website is a digital company profile project for PT Feliya Laju Teknik, a company engaged in the installation and maintenance of cooling systems and HVAC. This project was built as part of an internship program and aims to help the company present a professional face online.'
              }) }}
              </p>
            </div>
          </div>
